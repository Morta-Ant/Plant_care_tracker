...
class TestNavigation(TestCase):
    ...
    def test_collection_route(self):
        ...
        # Check if the page title is as expected
        page_title = soup.title.string
        self.assertEqual(page_title, ' Home')#the collection page goes to the home page from the navi bar unless the user is logged in
    ...
    def test_add_to_collection_route(self):
        ...
        # Check if the page title is as expected
        page_title = soup.title.string
        self.assertEqual(page_title, ' Home')#goes to the home page if the user is not logged in
